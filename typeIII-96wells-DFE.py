...
params, params_simulation = prepare_experiment(assumptions, seed = 2)

data_directory = "data/DFE/"
...
list_algorithms = ["resource","knock_in","knock_out","bottleneck","coalescence","migration"]
list_algorithms =["bottleneck"]
k =2
for j in range(len(list_phenotypes)):
    ...
    for i in range(len(list_algorithms)):
        simulate_community(
            ...
            file_name = data_directory + list_algorithms[i] + '_' + str(k),
